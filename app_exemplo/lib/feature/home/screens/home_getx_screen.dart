...
import 'package:app_exemplo/domain/controllers/friends_controller_getx.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final FriendsController c = Get.put(FriendsController());
  ...
  Widget build(BuildContext context) {
    print('HomeScreen GetX');

    return Scaffold(
      body: GetX<FriendsController>(
